...
class CloudflareZoneTest extends TestCase
{
    ...
    {
        $response = $this->getPsr7JsonResponseForFixture('addZone.json');
        ...
        $response = $this->getPsr7JsonResponseForFixture('createPageRule.json');
    ...
    {
        $response = $this->getPsr7JsonResponseForFixture('activationTest.json');
    ...
    {
        $response = $this->getPsr7JsonResponseForFixture('listZones.json');
    ...
    {
        $response = $this->getPsr7JsonResponseForFixture('getZoneById.json');
    ...
    {
        $response = $this->getPsr7JsonResponseForFixture('getZoneId.json');
    ...
    {
        $response = $this->getPsr7JsonResponseForFixture('getAnalyticsDashboard.json');
    ...
    {
        $response = $this->getPsr7JsonResponseForFixture('changeDevelopmentMode.json');
    ...
    {
        $response = $this->getPsr7JsonResponseForFixture('cachePurgeEverything.json');
    ...
    {
        $response = $this->getPsr7JsonResponseForFixture('cachePurgeHost.json');
    ...
    {
        $response = $this->getPsr7JsonResponseForFixture('cachePurge.json');
